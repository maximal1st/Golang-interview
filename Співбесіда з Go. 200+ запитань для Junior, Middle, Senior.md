...
Якщо читати з закритого каналу, то програма отримає помилку на етапі читання. Виклик буде заблоковано, доки інша горутина не запише до каналу, або поки канал не буде відкрито.

Якщо писати в закритий канал, то програма отримає помилку на етапі запису. Виклик буде заблоковано, доки інша горутина не прочитає дані з каналу, або поки канал не буде відкрито.

Отже, краще не писати у закриті канали, а завжди перевіряти, чи канал відкритий перед читанням або записом в нього.
